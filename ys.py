...
class YellowSpider:
    ...
    def choose_menu(self):
        print('=== Starting {0} V{1} ==='.format(colored.yellow(self.SCRIPT_NAME), colored.yellow(self.SCRIPT_VERSION)))
        print('{0} : Abord script'.format(colored.cyan('(1)')))
        print('{0} : Specific website'.format(colored.cyan('(2)')))
        print('{0} : Launch YellowSpider'.format(colored.cyan('(3)')))
        print('{0} : Exit'.format(colored.cyan('(0)')))
        mode = input()
